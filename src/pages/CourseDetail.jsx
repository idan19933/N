...
import { checkCourseOwnership, createPurchase, processPayment } from '../services/paymentService';
...
const CourseDetail = () => {
    ...
    const handlePurchase = async () => {
        ...
        try {
            ...
            const payment = await processPayment(courseId, course.price);

            if (payment.success) {
                // Create purchase record
                await createPurchase(user.uid, courseId, course.price);
                setOwned(true);
                alert('Course purchased successfully! You now have full access.');
            }
        } catch (error) {
