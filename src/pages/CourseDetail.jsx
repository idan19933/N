                            ...
                            {selectedLesson ? (
                                <div className="relative">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300 mt-2">{selectedLesson.description}</p>
                                    </div>
                                </div>
                            ) : (
                                <motion.img
                    ...
                    <div className="lg:sticky lg:top-8 lg:self-start">
                        ...
                        {hasPurchased && (
                            <motion.div
                                initial={{ scale: 0.9, opacity: 0 }}
                                animate={{ scale: 1, opacity: 1 }}
                                className="bg-green-50 dark:bg-green-900 border-2 border-green-500 dark:border-green-600 rounded-xl p-6 mb-6"
                            >
