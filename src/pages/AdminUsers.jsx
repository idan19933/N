...
import { Users, TrendingUp, DollarSign, BookOpen, Target, X } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 py-8" dir="rtl">
                <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-8">ניהול משתמשים</h1>
                                    ...
                                    <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                        ...
                                        <td className="py-4 px-6">
                                            <button
                                                ...
                                                className="px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors text-sm font-semibold flex items-center gap-2"
                                            >
                                                <Target size={16} />
                                                הוסף יעד
                                            </button>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 max-w-md w-full">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">הוסף יעד למשתמש</h2>
                                <button
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500"
                                ...
                                <div className="flex gap-3 pt-4">
                                    <button
                                        ...
                                        className="flex-1 px-6 py-3 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors font-semibold"
                                    >
                                        הוסף יעד
                                    </button>
                                    <button
