...
const topicsByGrade = {
    ...
    '10': ['אלגברה בסיסית', 'משוואות ריבועיים', 'פונקציות', 'גאומטריה אנליטית', 'טריגונומטריה בסיסית'],
    '11': ['פונקציות מתקדמות', 'חשבון דיפרנציאלי', 'גאומטריה במרחב', 'הסתברות מתקדמת'],
    '12': ['אינטגרלים', 'נגזרות מתקדמות', 'משוואות דיפרנציאליות', 'הכנה לבגרות']
};
